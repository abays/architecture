...
- The LVM operator should be installed and a storage class called `lvms-vg1` should already exist.
...
```
Change to the sno directory
```
cd architecture/examples/va/sno
```
